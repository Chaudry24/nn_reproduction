...
for i in range(n_epochs):
    ...
    # generate data
    print(f"generating data for {i}th time")
    ...
    # generate new data and train model 320 more iteration at the last i val
    if i == n_epochs - 1:

        print(f"THIS IS THE FINAL EPOCH")
        ...
        print("THE FINAL EPOCH HAS CONCLUDED")
